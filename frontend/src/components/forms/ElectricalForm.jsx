...
const ElectricalForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("/customer/electrical", data);
      alert("Electrical worker details submitted and saved!");
      setData({
        name: "",
        experience: "",
        availabilityTime: "",
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mt-20 relative w-full max-w-lg bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200 p-8 z-10 mx-4 sm:mr-20"
      >
        <h2 className="text-3xl font-bold text-center mb-6 text-blue-700">
          Electrical Worker Form
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5" >
          ...
          {/* Experience */}
          <div>
            <label className="block text-sm mb-2 text-gray-700">Experience (in years)</label>
            <input
              type="number"
              name="experience"
              placeholder="e.g. 3"
          ...
          {/* Availability */}
          <div>
            <label className="block text-sm mb-2 text-gray-700">Availability Time</label>
            <input
              type="text"
          ...
          {/* Contact Info */}
          <div>
            <label className="block text-sm mb-2 text-gray-700">Contact Info</label>
            <input
              type="text"
              name="contactInfo"
