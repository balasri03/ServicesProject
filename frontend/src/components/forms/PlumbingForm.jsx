...
const PlumbingForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("/customer/plumbing", data);
      alert("Plumbing worker details submitted and saved!");
      setData({
        name: "",
        address: "",
        availabilityTime: "",
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              type="text"
              name="specialization"
              placeholder="E.g., Pipe Repair, Bathroom Fittings, Water Tank Installation"
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 rounded-xl bg-gray-100 text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
